/**
 * This is a version of the Character component for testing
 * For some reason the StickyBox import was causing errors
 * Since the sticky behavior of the box is not a critical function, it has been removed for testing
 */
